<script>
	...
	const faqs = [
		...
		},
		{
			...
			answer: 'Typically, within 48 hours or less.'
		},
		{
		...
		},
		{
			...
			answer:
				'Neither, actually! Everything is a code snippet that browser renders real-time. In practice, it means super tiny size and fast performance.'
		},
		{
